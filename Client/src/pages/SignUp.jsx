...
export const SignUp = () => {
    ...
    return (
        <>
            <div className="mt-28 px-4 flex flex-1 flex-col justify-center sm:px-6">
                <div className="sm:mx-auto sm:w-full sm:max-w-md">
                    ...
                    <h2 className="mt-6 text-center text-2xl/9 font-bold tracking-tight text-gray-900">Create account</h2>
                </div>
                    ...
                    <div className="bg-white px-6 py-12 shadow-sm sm:rounded-lg sm:px-12">
                        ...
                        <div>
                            ...
                            <div className="mt-6 grid grid-cols-2 gap-4">
                                <button onClick={handleRegister} className="flex w-full items-center justify-center gap-3 rounded-md bg-white px-3 py-2 text-sm font-semibold text-gray-900 shadow-xs ring-1 ring-gray-300 ring-inset hover:bg-gray-50 focus-visible:ring-transparent">
